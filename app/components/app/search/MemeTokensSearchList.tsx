...
interface MemeTokensSearchListProps {
  tokens: MemeToken[];
}

export function MemeTokensSearchList({ tokens }: MemeTokensSearchListProps) {
  return (
    <>
      <div className="flex items-center justify-between mb-4 sm:mb-6">
        <div className="flex items-center gap-2 sm:gap-4 bg-neutral-900 rounded-md p-1.5 sm:p-2">
      ...
      <div className="col-span-1 xl:col-span-3 bg-neutral-900  border p-2 sm:p-4 xl:p-4  border-neutral-800 rounded-xl min-h-[350px] sm:min-h-[400px] lg:min-h-[500px] xl:min-h-[600px] flex flex-col">
