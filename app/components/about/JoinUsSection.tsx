    ...
    <section className="py-16 md:py-24 bg-gray-900/50">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="max-w-2xl mx-auto text-lg text-gray-300 leading-relaxed mb-8">
          Memed.fun is more than just a platform—it's a community. Whether
          you're a creator, a degen, or just a meme lover, there's a place for
          you here. Let's build the future of meme culture together.
        </p>
