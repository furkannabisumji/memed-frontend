...
const antiSniperData = {
  ...
  multiLayer: {
    ...
    items: [
      ...
      { icon: Wallet, text: 'Wallet Caps: 500 GHO/address during fundraising (Reviewable) (300 without social proof)' },
    ],
  },
  dynamicFees: {
    title: 'Dynamic Fees',
    ...
    <section className="py-12 md:py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-8">{antiSniperData.title}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            
            <div className="space-y-6">
              <div className="bg-gray-900/50 p-6 rounded-lg border border-green-500/20">
                <h3 className="text-xl font-semibold text-green-400 mb-4">{antiSniperData.multiLayer.title}</h3>
              ...
              <div className="bg-gray-900/50 p-6 rounded-lg border border-green-500/20">
                <h3 className="text-xl font-semibold text-green-400 mb-4">{antiSniperData.dynamicFees.title}</h3>
                <ul className="space-y-3">
            ...
            <div className="bg-black/30 p-6 rounded-lg border border-gray-700">
              <h3 className="text-xl font-semibold text-green-400 mb-4">{antiSniperData.smartContractExample.title}</h3>
