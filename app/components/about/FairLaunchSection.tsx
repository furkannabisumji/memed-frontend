...
const fairLaunchData = {
  ...
  fundraising: {
    ...
    items: [
      ...
      {
        icon: TrendingUp,
        text: "Commit-Reveal: Max 500 GHO/wallet, unknown final price.",
      },
      {
        icon: ThumbsDown,
        text: "Lens Verification required for large commitments.",
      },
    ],
  },
  earlyLaunch: {
  ...
  engagement: {
    ...
    items: [
      {
        icon: Users,
        text: "Daily Progress Updates: Real-time progress bars and countdowns in the dApp.",
      },
      {
        icon: Megaphone,
        text: "Community Calls & Socials: Regular engagement to maintain hype and transparency.",
      },
      {
        icon: Info,
        text: "Clear Communication: Users are informed that the 7-day window is for fairness, inclusivity, and anti-bot protection.",
      },
    ],
  },
};
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-gray-900/50 p-6 rounded-lg border border-green-500/20">
                <h3 className="text-xl font-semibold text-green-400 mb-2">
                  {fairLaunchData.earlyLaunch.title}
                </h3>
                <p className="text-gray-300">
                  {fairLaunchData.earlyLaunch.description}
                </p>
              </div>
              <div className="bg-red-900/30 p-6 rounded-lg border border-red-500/30">
                <h3 className="text-xl font-semibold text-red-400 mb-2">
                  {fairLaunchData.failure.title}
                </h3>
                <p className="text-gray-300">
                  {fairLaunchData.failure.description}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 bg-gray-900/50 p-6 rounded-lg border border-green-500/20">
            <h3 className="text-2xl font-semibold text-green-400 mb-4">
              {fairLaunchData.engagement.title}
            </h3>
            <ul className="space-y-3">
