    ...
    <section className="py-12 md:py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-white mb-8">{differentiationData.title}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {differentiationData.points.map((point, index) => (
              <div key={index} className="flex items-start p-4 bg-gray-900/50 rounded-lg border border-green-500/10">
