const tokenDistributionData = {
  ...
  rows: [
    [
      "Fair Launch (Curve)",
      "200M (20%)",
      "Price discovery + fundraising",
      "Bonding curve active for 7-day fair launch only",
    ],
    [
      "Staking Rewards",
      "200M (20%)",
      "Meme token staking incentives",
    ...
    [
      "Engagement Rewards",
      "150M (15%)",
      "Monthly rewards for Lens activity",
      "Released every 4 days",
    ],
    [
      "Uniswap LP",
      "300M (30%)",
      "Liquidity pool seeded",
      "19,000 GHO (of 20,000 raised) paired with 300M MEME tokens",
    ],
  ],
};
